...
class PlantViewModel(application: Application): ViewModel() {
    ...
    internal fun scheduleReminder(
        ...
        //  instance
        var scheduleWorkRequest = OneTimeWorkRequest.Builder(WaterReminderWorker::class.java)
            .setInputData(data)
            .setInitialDelay(duration, unit)
            .build()

        // TODO: Enqueue the request as a unique work request
        workManager.enqueueUniqueWork(plantName, ExistingWorkPolicy.REPLACE, scheduleWorkRequest)
    }
}
